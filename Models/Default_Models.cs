...
/// <summary>
/// Represents a contact entity with various attributes such as status, display
/// name, and associated business account.
/// </summary>
/// <remarks>This model is typically used to store and manage information about
/// a contact in a business context. It includes properties for identifying the
/// contact, tracking its status, and associating it with other
/// entities.</remarks>
...
/// <summary>
/// Represents a customer entity, including details about the customer's
/// account, preferences, and associated data.
/// </summary>
/// <remarks>The <see cref="Customer_Model.Customer"/> class provides properties
/// and methods to manage customer-related information, such as account
/// identifiers, billing and shipping details, financial preferences, and other
/// attributes. This class is primarily used in business applications to handle
/// customer data and interactions.</remarks>
public class Customer_Model {
  /// <summary>
  /// Represents a customer entity, including details about the customer's
  /// account, preferences, and associated data.
  /// </summary>
  /// <remarks>The <see cref="Customer"/> class provides properties and methods
  /// to manage customer-related information,  such as account identifiers,
  /// billing and shipping details, financial preferences, and other attributes.
  /// This class is primarily used in business applications to handle customer
  /// data and interactions.</remarks>
  [DataContract]
  public class Customer : Entity, ITopLevelEntity {
    ...
    /// </summary>
    /// <remarks>
    /// It can be an additional number of the business account used in external
    /// integration.
    /// </remarks>
    ...
    /// <summary>
    /// If set to true, indicates that financial chargescan be calculated for
    /// the customer. DAC Field Name: FinChargeApply DAC: PX.Objects.AR.Customer
    ...
    /// <summary>
    /// Gets or sets the collection of attribute values associated with the
    /// entity.
    /// </summary>
    ...
    /// <summary>
    /// If set to true, indicates that the payments of the customershould be
    /// automatically applied to the open invoices upon release. DAC:
    /// PX.Objects.AR.Customer Display Name: Auto-Apply Payments
    /// </summary>
    ...
    /// <summary>
    /// The identifier of the related business account.Along with ContactID,
    /// this field is used as an additional reference,but unlike RefNoteID and
    /// DocumentNoteID it is used for specific entities. DAC:
    /// PX.Objects.CR.CRPMTimeActivity Display Name: Related Account
    /// </summary>
    [DataMember(Name = "BAccountID", EmitDefaultValue = false)]
    public IntValue BAccountID {
      get; set;
    }

    /// <summary>
    /// A calculated field. If set to false, indicates thatthe customer's
    /// billing address is the same as the customer'sdefault address.The field
    /// is populated by a formula, working only in the scope of the Customers
    /// (AR303000) form. See CustomerBillSharedAddressOverrideGraphExt" DAC
    /// Field Name: OverrideBillAddress DAC: PX.Objects.AR.Customer Display
    /// Name: Override
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the billing contact information associated with the
    /// account.
    /// </summary>
    ...
    /// <summary>
    /// A calculated field. If set to false, indicates that the customer's
    /// billing contact is the same as the customer'sdefault contact.The field
    /// is populated by a formula, working only in the scope of the Customers
    /// (AR303000) form. See CustomerBillSharedContactOverrideGraphExt" DAC
    /// Field Name: OverrideBillContact DAC: PX.Objects.AR.Customer Display
    /// Name: Override
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the collection of customer contacts associated with the
    /// entity.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the credit verification rules used to validate
    /// credit-related operations.
    /// </summary>
    [DataMember(Name = "CreditVerificationRules", EmitDefaultValue = false)]
    public CreditVerificationRules CreditVerificationRules {
      get; set;
    }

    /// <summary>
    /// The identifier of the Currency,which is applied to the documents of the
    /// customer. DAC Field Name: CuryID DAC: PX.Objects.AR.Customer Display
    /// Name: Currency ID SQL Type: nvarchar(5)
    /// </summary>
    ...
    /// <summary>
    /// The identifier of the currency rate type,which is applied to the
    /// documents of the customer. DAC Field Name: CuryRateTypeID DAC:
    /// PX.Objects.AR.Customer Display Name: Curr. Rate Type SQL Type:
    /// nvarchar(6)
    /// </summary>
    ...
    /// <summary>
    /// The human-readable identifier of the customer account, which isspecified
    /// by the user or defined by the auto-numbering sequence duringcreation of
    /// the customer. This field is a natural key, as opposedto the surrogate
    /// key BAccountID. DAC Field Name: AcctCD DAC: PX.Objects.AR.Customer
    ...
    /// <summary>
    /// The customer kind, indicating whether the customer is an individual (I)
    /// or an organization (O). DAC: PX.Objects.AR.Customer Display Name:
    /// Customer Category SQL Type: char(1)
    /// </summary>
    [DataMember(Name = "CustomerCategory", EmitDefaultValue = false)]
    public StringValue CustomerCategory {
      get; set;
    }

    /// <summary>
    /// The full business account name (as opposed to the short identifier
    /// provided by AcctCD). DAC Field Name: AcctName DAC:
    /// PX.Objects.AR.Customer Display Name: Customer Name SQL Type:
    /// nvarchar(255)
    /// </summary>
    ...
    /// <summary>
    /// If set to true, indicates that the currency of customer documents (which
    /// is specified by CuryID)can be overridden by a user during document
    /// entry. DAC Field Name: AllowOverrideCury DAC: PX.Objects.AR.Customer
    /// Display Name: Enable Currency Override
    /// </summary>
    [DataMember(Name = "EnableCurrencyOverride", EmitDefaultValue = false)]
    public BooleanValue EnableCurrencyOverride {
      get; set;
    }

    /// <summary>
    /// If set to true, indicates that the currency ratefor customer documents
    /// (which is calculated by the system from the currency rate history) can
    /// be overridden by a user during document entry. DAC Field Name:
    /// AllowOverrideRate DAC: PX.Objects.AR.Customer Display Name: Enable Rate
    /// Override
    /// </summary>
    [DataMember(Name = "EnableRateOverride", EmitDefaultValue = false)]
    public BooleanValue EnableRateOverride {
      get; set;
    }

    /// <summary>
    /// If set to true, indicates that small balancewrite-offs are allowed for
    /// the customer. DAC Field Name: SmallBalanceAllow DAC:
    /// PX.Objects.AR.Customer Display Name: Enable Write-Offs
    /// </summary>
    ...
    /// <summary>
    /// The amount of lead days (the time in days from the moment when the
    /// production was finished to the moment when the customer's order was
    /// delivered). DAC Field Name: CLeadTime DAC:
    /// PX.Objects.CR.Standalone.Location Display Name: Lead Time (Days)
    /// </summary>
    ...
    /// <summary>
    /// If set to true, indicates that customerstatements should be generated
    /// for the customer in multi-currency format. DAC Field Name:
    /// PrintCuryStatements DAC: PX.Objects.AR.Customer Display Name:
    /// Multi-Currency Statements
    /// </summary>
    [DataMember(Name = "MultiCurrencyStatements", EmitDefaultValue = false)]
    public BooleanValue MultiCurrencyStatements {
      get; set;
    }
    ...
    /// <summary>
    /// Gets or sets the collection of payment instructions associated with the
    /// business account.
    /// </summary>
    [DataMember(Name = "PaymentInstructions", EmitDefaultValue = false)]
    public List<BusinessAccountPaymentInstructionDetail> PaymentInstructions {
      get; set;
    }
    ...
    /// <summary>
    /// The identifier of the Contact object linked with the business account
    /// and marked as primary. DAC: PX.Objects.AR.Customer Display Name: Primary
    /// Contact
    /// </summary>
    /// <remarks>
    /// Also, the Contact.BAccountID value must equal tothe BAccount.BAccountID
    /// value of the current business account.
    /// </remarks>
    [DataMember(Name = "PrimaryContactID", EmitDefaultValue = false)]
    public IntValue PrimaryContactID {
      get; set;
    }

    /// <summary>
    /// If set to true, indicates that dunning letters should be printed for the
    /// customer. DAC: PX.Objects.AR.Customer Display Name: Print Dunning
    /// Letters
    /// </summary>
    [DataMember(Name = "PrintDunningLetters", EmitDefaultValue = false)]
    public BooleanValue PrintDunningLetters {
      get; set;
    }

    /// <summary>
    /// If set to true, indicates that invoicesshould be printed for the
    /// customer. DAC: PX.Objects.AR.Customer Display Name: Print Invoices
    /// </summary>
    ...
    /// <summary>
    /// If set to true, indicates that customerstatements should be printed for
    /// the customer. DAC: PX.Objects.AR.Customer Display Name: Print Statements
    /// </summary>
    ...
    /// <summary>
    /// This field indicates whether the residential delivery is available in
    /// this location. DAC Field Name: CResedential DAC:
    /// PX.Objects.CR.Standalone.Location Display Name: Residential Delivery
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the collection of salespersons associated with the
    /// customer.
    /// </summary>
    ...
    /// <summary>
    /// This field indicates whether the Saturday delivery is available in this
    /// location. DAC Field Name: CSaturdayDelivery DAC:
    /// PX.Objects.CR.Standalone.Location Display Name: Saturday Delivery
    /// </summary>
    ...
    /// <summary>
    /// If set to true, indicates that dunning letters should be sent to the
    /// customer by email. DAC Field Name: MailDunningLetters DAC:
    /// PX.Objects.AR.Customer Display Name: Send Dunning Letters by Email
    /// </summary>
    [DataMember(Name = "SendDunningLettersbyEmail", EmitDefaultValue = false)]
    public BooleanValue SendDunningLettersbyEmail {
      get; set;
    }

    /// <summary>
    /// If set to true, indicates that invoicesshould be sent to the customer by
    /// email. DAC Field Name: MailInvoices DAC: PX.Objects.AR.Customer Display
    ...
    /// <summary>
    /// If set to true, indicates that the addressoverrides the default Address
    /// record, which isreferenced by DefAddressID. DAC Field Name:
    /// OverrideAddress DAC: PX.Objects.CR.Standalone.Location Display Name:
    /// Override
    /// </summary>
    ...
    /// <summary>
    /// If set to true, indicates that the addressoverrides the default Contact
    /// record, which isreferenced by DefContactID. DAC Field Name:
    /// OverrideContact DAC: PX.Objects.CR.Standalone.Location Display Name:
    /// Override
    /// </summary>
    ...
    /// <summary>
    /// The type of customer statements generated for the customer.The list of
    /// possible values of the field is determined by StatementTypeAttribute.
    /// DAC: PX.Objects.AR.Customer
    /// Display Name: Statement Type
    /// SQL Type: char(1)
    /// </summary>
    [DataMember(Name = "StatementType", EmitDefaultValue = false)]
    public StringValue StatementType {
      get; set;
    }
    ...
    /// <summary>
    /// The identifier of the default terms, which are applied to the documents
    /// of the customer. DAC Field Name: TermsID DAC: PX.Objects.AR.Customer SQL
    /// Type: nvarchar(10)
    /// </summary>
    ...
    /// <summary>
    /// If SmallBalanceAllow is set to true, thefield determines the maximum
    /// small balance write-off limit for customer documents. DAC Field Name:
    /// SmallBalanceLimit DAC: PX.Objects.AR.Customer Display Name: Write-Off
    /// Limit
    /// </summary>
    ...
    public StringValue RestrictVisibilityTo {
      get; set;
    }

    /// <summary>
    /// If CreditRule enables verification by credit limit,this field determines
    /// the maximum amount of credit allowed for the customer. DAC:
    /// PX.Objects.AR.Customer Display Name: Credit Limit
    /// </summary>
    ...
    /// <summary>
    /// The customer's entity type for reporting purposes. This field is used if
    /// the system is integrated with External Tax Calculationand the External
    /// Tax Calculation Integration feature is enabled. DAC Field Name:
    /// CAvalaraCustomerUsageType DAC: PX.Objects.CR.Standalone.Location Display
    /// Name: Tax Exemption Type SQL Type: char(1)
    /// </summary>
    [DataMember(Name = "EntityUsageType", EmitDefaultValue = false)]
    public StringValue EntityUsageType {
      get; set;
    }
    ...
    public StringValue TaxExemptionNumber {
      get; set;
    }
    ...
    public BooleanValue IsGuestCustomer {
      get; set;
    }
    ...
    /// </summary>
    /// <remarks>This method returns a predefined endpoint path and does not
    /// perform any dynamic computation. It can be overridden in derived classes
    /// to provide a custom endpoint path.</remarks> <returns>A string
    /// representing the endpoint path in the format
    /// "entity/Default/24.200.001".</returns>
...
#region Opportunity_Model
  ...
  /// <summary>
  /// Gets or sets the display name of the contact associated with the
  /// opportunity.
  /// </summary>
